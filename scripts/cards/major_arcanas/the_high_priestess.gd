class_name TheHighPriestess extends MajorArcana
...
func get_background() -> String:
	return "res://assets/card/major_arcanas/HIGHPRIESTESS/1-BG.png"
	
func get_middleground() -> String:
	return "res://assets/card/major_arcanas/HIGHPRIESTESS/2-Person/Comp 1_00000.png"

func get_foreground() -> String:
	return "res://assets/card/major_arcanas/HIGHPRIESTESS/3-Moon/Comp 1_00000.png"
