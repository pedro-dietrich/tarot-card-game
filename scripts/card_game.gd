...
const LVL_ADDITIONAL_CARDS = [0,0, 0, 1, 1, 1, 2, 2]
const LVL_MAX_CARDS_PLAYED = [4, 4, 5, 5, 6, 6, 7, 9]
const LVL_TARGET_SCORE = [40, 50, 65, 75, 90, 100, 115, 150]
...
func play_card(played_card) -> void:
	var zpos = -1.2 + (played_cards.size()*0.25)
